...
const GeneralServiceListDetails = ({ service }) => {
  return (
    <Col xs={12} md={10} lg={6} className="text-left">
      <Card
        className="general-service-list-details-card mt-5"
        ...
        <Card.Body style={{ margin: "auto" }}>
          <div className="d-flex justify-content-between align-items-center">
            <img
              ...
              src={`data:${service.projectImage?.contentType};base64,${service.projectImage?.img}`}
              alt=""
            />
          ...
          <Card.Title
            style={{ fontSize: "20px", fontWeight: "600", color: "#111430" }}
          >
